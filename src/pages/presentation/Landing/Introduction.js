          ...
          <Grid item xs={12} sm={9} md={8} lg={7}>
            <Content>
              <Title variant="h1" gutterBottom>
                <div>
                  Modern and Responsive <span>UI</span>{" "}
                </div>{" "}
                for leverjs cell tracking challenge
              </Title>
              <Grid container justify="center" spacing={4}>
                <Grid item xs={12} lg={10}>
                  <Subtitle color="textSecondary">
                    This leverjs dashboard comes with all the cell tracking
                    challenge results pulled directly from the leverjs server.
                    Display the results in graphs and compare their SEG, DET,
                    and TRA scores.
                  </Subtitle>
                </Grid>
              </Grid>
