  ...
  return (
    <Drawer variant="permanent" {...rest}>
      <Brand component={NavLink} to="/" button>
        <Box ml={1}>
          leverjs <BrandChip label="DASHBOARD" />
        </Box>
      </Brand>
      <Scrollbar>
        <List disablePadding>
        ...
        <Grid container spacing={2}>
          <Grid item>
            ...
            >
              <Avatar
                alt="Andrew Cohen"
                src="/static/img/avatars/cohen-andrew.jpeg"
              />
            </SidebarFooterBadge>
          </Grid>
          <Grid item>
            <SidebarFooterText variant="body2">Andrew Cohen</SidebarFooterText>
            <SidebarFooterSubText variant="caption">
              Computer Engineer | Professor
